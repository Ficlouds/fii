...
export class AgentGroupController extends BaseController {
  ...
  async getAgentGroups(c: Context): Promise<Response> {
    try {
      ...
      return this.success(c, agentGroups, 'Get agent group list successfully');
    } catch (error) {
  ...
  async getAgentGroupById(c: Context): Promise<Response> {
    try {
      ...
      if (!groupId) {
        return this.error(c, 'Agent group ID is required', 400);
      }
      ...
      if (!agentGroup) {
        return this.error(c, 'Agent group not found', 404);
      }

      return this.success(c, agentGroup, 'Get agent group details successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
  ...
  async updateAgentGroup(c: Context): Promise<Response> {
    try {
      ...
      return this.success(c, null, 'Agent group updated successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
  ...
  async deleteAgentGroup(c: Context): Promise<Response> {
    try {
      ...
      return this.success(c, null, 'Agent group deleted successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
