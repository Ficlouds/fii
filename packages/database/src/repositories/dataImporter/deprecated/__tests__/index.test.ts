          ...
          sessions: [
            {
              ...
              meta: {
                avatar: '📝',
                description:
                  'Fi is an AI conversation application built with the Next.js framework. I will help you write the development documentation for Fi.',
                tags: [
                ...
                title: 'Fi Technical Documentation Expert',
              },
              type: 'agent',
