...
**Setup Guide:** https://ficlouds.com/docs/usage/channels/wechat
...
WeChat requires a QR code scan to link your account, which is only supported through the Fi Web UI:

1. Open your agent in Fi
