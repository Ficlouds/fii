...
import { FiAgentApiName, FiAgentIdentifier } from './types';

export const FiAgentManifest: BuiltinToolManifest = {
  api: [
    {
      description:
      ...
      name: FiAgentApiName.analyzeVisualMedia,
      parameters: {
    ...
    // ==================== Planning ====================
    {
      ...
      name: FiAgentApiName.createPlan,
    ...
    },
    {
      ...
      name: FiAgentApiName.updatePlan,
      parameters: {
        properties: {
          planId: {
            description:
    ...
    // ==================== Quick Todo ====================
    {
      ...
      name: FiAgentApiName.createTodos,
      humanIntervention: 'required',
      parameters: {
        properties: {
          adds: {
...
- "processing": requires "index" only (marks item as in progress)`,
      name: FiAgentApiName.updateTodos,
      renderDisplayControl: 'expand',
      parameters: {
        properties: {
          operations: {
    ...
    },
    {
      ...
      name: FiAgentApiName.clearTodos,
    ...
    // ==================== Sub-Agent ====================
    {
      ...
      name: FiAgentApiName.callSubAgent,
      parameters: {
        properties: {
          description: {
    ...
    },
    {
      ...
      name: FiAgentApiName.callSubAgents,
      parameters: {
        properties: {
          tasks: {
