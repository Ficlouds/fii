...
export class TopicController extends BaseController {
  ...
  async handleGetTopics(c: Context) {
    try {
      ...
      return this.success(c, topics, 'Get topic list successfully');
    } catch (error) {
  ...
  async handleGetTopicById(c: Context) {
    try {
      ...
      return this.success(c, topic, 'Get topic successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
  ...
  async handleCreateTopic(c: Context) {
    try {
      ...
      return this.success(c, newTopic, 'Create topic successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
  ...
  async handleUpdateTopic(c: Context) {
    try {
      ...
      return this.success(c, updatedTopic, 'Update topic successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
  ...
  async handleDeleteTopic(c: Context) {
    try {
      ...
      return this.success(c, null, 'Delete topic successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
