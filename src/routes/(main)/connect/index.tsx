...
const MCP_APPS = [
  ...
  // Google Workspace
  { id: 'gmail', name: 'Gmail', desc: 'Read, compose and manage your emails', category: 'Google', url: 'https://gmailmcp.googleapis.com/mcp/v1', logo: 'https://www.google.com/s2/favicons?domain=gmail.com', auth: 'oauth' },
  { id: 'gdrive', name: 'Google Drive', desc: 'Search, read and upload files', category: 'Google', url: 'https://drivemcp.googleapis.com/mcp/v1', logo: 'https://www.google.com/s2/favicons?domain=drive.google.com', auth: 'oauth' },
  { id: 'gcalendar', name: 'Google Calendar', desc: 'Manage events and schedule meetings', category: 'Google', url: 'https://calendarmcp.googleapis.com/mcp/v1', logo: 'https://www.google.com/s2/favicons?domain=calendar.google.com', auth: 'oauth' },
  { id: 'gsheets', name: 'Google Sheets', desc: 'Spreadsheets and data analysis', category: 'Google', url: 'https://drivemcp.googleapis.com/mcp/v1', logo: 'https://www.google.com/s2/favicons?domain=sheets.google.com', auth: 'oauth' },
  { id: 'gdocs', name: 'Google Docs', desc: 'Documents and collaborative writing', category: 'Google', url: 'https://drivemcp.googleapis.com/mcp/v1', logo: 'https://www.google.com/s2/favicons?domain=docs.google.com', auth: 'oauth' },
  // Microsoft
  { id: 'outlook', name: 'Outlook', desc: 'Email, calendar and contacts', category: 'Microsoft', url: 'https://agent365.svc.cloud.microsoft', logo: 'https://www.google.com/s2/favicons?domain=outlook.com', auth: 'oauth' },
  { id: 'onedrive', name: 'OneDrive', desc: 'Cloud file storage and sharing', category: 'Microsoft', url: 'https://agent365.svc.cloud.microsoft', logo: 'https://www.google.com/s2/favicons?domain=onedrive.live.com', auth: 'oauth' },
  { id: 'teams', name: 'Microsoft Teams', desc: 'Team messaging and video meetings', category: 'Microsoft', url: 'https://agent365.svc.cloud.microsoft', logo: 'https://www.google.com/s2/favicons?domain=teams.microsoft.com', auth: 'oauth' },
  { id: 'excel', name: 'Microsoft Excel', desc: 'Spreadsheets and data analysis', category: 'Microsoft', url: 'https://agent365.svc.cloud.microsoft', logo: 'https://www.google.com/s2/favicons?domain=office.com', auth: 'oauth' },
  // Social & Content
...
const AppIcon = ({ logo, name }: { logo: string; name: string }) => {
  ...
  const googleFavicon = logo.replace('https://www.google.com/s2/favicons?domain=', '');
  const faviconUrl = `https://www.google.com/s2/favicons?domain=${googleFavicon}&sz=64`;
  return (
    <div style={{
      alignItems: 'center',
