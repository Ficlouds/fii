export default {
  ...
  'claudeCodeInstallGuide.reason': 'Fi could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'Fi could not start Codex: {{message}}',
  ...
  'plus.search.appSearchDesc':
    'Fi optimized search service, delivering best retrieval results.',
  ...
  'sendPlaceholder': "What do you want to know? <hotkey><hotkey/>",
  ...
  'sharePageDisclaimer':
    'This content is shared by a user and does not represent the views of Fi. Fi is not responsible for any consequences arising from this shared content.',
  ...
  'taskList.unassignedHint': 'Fi will run this task when no assignee is set',
