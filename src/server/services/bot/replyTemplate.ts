...
const SYSTEM_STRINGS: Partial<Record<BotReplyLocale, SystemStrings>> = {
  'en-US': {
    ...
    cmdFeedbackSubmitted: 'Thanks — your feedback has been sent to the Fi team.',
    cmdFeedbackSubmittedWithLink: (issueUrl) =>
      `Thanks — your feedback has been sent to the Fi team. Tracked at: ${issueUrl}`,
    cmdFeedbackUsage:
      'Usage: `/feedback <your message>` — sends feedback directly to the Fi team (no AI reply).',
  ...
  'zh-CN': {
    ...
    cmdFeedbackSubmitted: '已收到，感谢反馈，已转交 Fi 团队。',
    cmdFeedbackSubmittedWithLink: (issueUrl) =>
      `已收到，感谢反馈，已转交 Fi 团队。跟踪链接：${issueUrl}`,
    cmdFeedbackUsage:
      '用法：`/feedback <你的反馈内容>` —— 反馈会直达 Fi 团队，不会触发 AI 回复。',
