import { LOBE_CHAT_OBSERVATION_ID, LOBE_CHAT_TRACE_ID, MESSAGE_CANCEL_FLAT } from '@ficlouds/const';
import { parseToolCalls } from '@ficlouds/model-runtime';
import type {
  ChatImageChunk,
  ChatMessageError,
  GroundingSearch,
...
import { nanoid } from '@ficlouds/utils/uuid';
