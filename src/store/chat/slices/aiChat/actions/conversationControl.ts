...
export class ConversationControlActionImpl {
   ...
   * pattern from Gateway-mode stop/interrupt (WS interrupt wire).
   *
   ...
   * implemented and falls through to client local resume — routed via agentDispatcher.selectRuntimeType.
   *
