...
// urgent brief surface for human attention. Hardcoded for now (QStash heartbeat self-rescheduling via delayed publish);
...
export class TaskLifecycleService {
  ...
  async onTopicComplete(params: TopicCompleteParams): Promise<void> {
    ...
    if (reason === 'done') {
      ...
      //    the GrowthBook flag flips. See brief auto-synthesis rollout plan (GrowthBook-controlled).
