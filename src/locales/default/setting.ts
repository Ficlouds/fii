export default {
  ...
  'memory.enabled.desc':
    'Allow Fi to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'settingAppearance.appTray.desc':
    'Show the Fi icon in the system tray or macOS menu bar. Disabling it also removes tray menu access.',
  ...
  'settingSelfIteration.enabled.managedDesc':
    'Always on for Fi while Self-Iteration is available.',
  ...
  'settingSystemTools.tools.fi.desc': 'Fi CLI - manage and connect to Fi services',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tools.builtins.lobe-skill-store.description':
    'Browse and install agent skills from the Fi marketplace. Use this when you need extended capabilities or want to install a specific skill.',
  ...
  'tools.builtins.fi.description':
    'Manage the Fi platform via CLI — knowledge bases, memory, agents, files, search, generation, and more.',
  'tools.builtins.fi.title': 'Fi',
