...
- **Secret Token** (optional): a custom string you define; Fi includes it in webhook requests so you can verify they genuinely come from Fi — leave blank unless you have a security requirement
