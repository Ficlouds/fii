...
export const OFFICIAL_URL = 'https://app.ficlouds.com';
export const OFFICIAL_SITE = 'https://ficlouds.com';
export const OFFICIAL_DOMAIN = 'ficlouds.com';

export const OG_URL = '/og/og.webp?v=1';

export const GITHUB = 'https://github.com/lobehub/lobe-chat';
export const GITHUB_ISSUES = urlJoin(GITHUB, 'issues/new/choose');
export const CHANGELOG = 'https://ficlouds.com/changelog';
...
export const PLUGINS_INDEX_URL = 'https://chat-plugins.ficlouds.com';
...
export const AGENTS_OFFICIAL_URL = 'https://ficlouds.com/agent';
...
export const BASE_PROVIDER_DOC_URL = 'https://ficlouds.com/docs/usage/providers';
