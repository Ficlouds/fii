...
export const createServerToolsEngine = (
  ...
  // and the activator bypass fix. The enableChecker rules below are defense-in-depth
  ...
  // the second half of the device-access wall: an installed plugin or a
...
export const createServerAgentToolsEngine = (
  ...
  return createServerToolsEngine(context, {
    ...
    // gates below (manifest filter is the primary hard gate).
