import type { BuiltinToolContext, BuiltinToolResult, ChatStreamPayload } from '@ficlouds/types';
import { BaseExecutor, RequestTrigger } from '@ficlouds/types';
...
class FiAgentExecutor extends BaseExecutor<typeof FiAgentApiName> {
  readonly identifier = FiAgentManifest.identifier;
  protected readonly apiEnum = FiAgentApiName;
...
export const fiAgentExecutor = new FiAgentExecutor();
