...
import type { ListLocalFilesResult, LocalReadFileResult } from '@ficlouds/electron-client-ipc';
import { formatFileContent, formatFileList } from '@ficlouds/prompts';
import type { LocalSystemToolSnapshot } from '@ficlouds/types';
