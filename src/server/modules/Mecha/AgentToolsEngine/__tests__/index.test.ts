...
describe('createServerToolsEngine', () => {
  ...
  it('drops device manifests from every source when excludeIdentifiers is set (activator bypass fix)', () => {
...
describe('createServerAgentToolsEngine', () => {
  ...
  describe('RemoteDevice tool enable rules', () => {
    ...
    it('should enable RemoteDevice in bot conversations when caller is trusted (canUseDevice=true)', () => {
      // The `!isBotConversation` clause was dropped with the sender-based device access policy — the
  ...
  describe('canUseDevice gate (sender-based device access policy)', () => {
