...
export class UserController extends BaseController {
  ...
  async getCurrentUser(c: Context): Promise<Response> {
    try {
      ...
      return this.success(c, userInfo, 'Get user information successfully');
    } catch (error) {
  ...
  async queryUsers(c: Context): Promise<Response> {
    try {
      ...
      return this.success(c, userList, 'Get user list successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
  ...
  async getUserById(c: Context): Promise<Response> {
    try {
      ...
      return this.success(c, user, 'Get user information successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
  ...
  async updateUser(c: Context): Promise<Response> {
    try {
      ...
      return this.success(c, updatedUser, 'User information updated successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
  ...
  async getUserRoles(c: Context): Promise<Response> {
    try {
      ...
      return this.success(c, userRoles, 'Get user roles successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
