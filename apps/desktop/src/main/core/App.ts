...
import type { ElectronIPCEventHandler } from '@ficlouds/electron-server-ipc';
import { ElectronIPCServer } from '@ficlouds/electron-server-ipc';
...
export class App {
  ...
  private initDevBranding = () => {
    ...
    app.setName('ficlouds-desktop-dev');
    if (electronIs.macOS()) {
