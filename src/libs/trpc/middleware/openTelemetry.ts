...
import { type Attributes, type Span } from '@ficlouds/observability-otel/api';
import { context, diag, SpanKind, SpanStatusCode, trace } from '@ficlouds/observability-otel/api';
import {
  ATTR_ERROR_TYPE,
...
} from '@ficlouds/observability-otel/trpc';
