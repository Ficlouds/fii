  ...
  protected async requirePermission(
    ...
    if (!hasPermission) {
      throw new HTTPException(403, {
        message: errorMessage || `You do not have permission to perform this action: ${permission}`,
      });
    }
  }
  ...
  protected async requireAnyPermission(
    ...
    if (!hasPermission) {
      throw new HTTPException(403, {
        message:
          errorMessage ||
          `You do not have permission to perform this action, one of the following permissions is required: ${permissionKeys
