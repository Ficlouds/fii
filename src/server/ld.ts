import { BRANDING_EMAIL, BRANDING_NAME, SOCIAL_URL } from '@ficlouds/business-const';
  ...
  genOrganization() {
    return {
      ...
      'description':
        ...
        'Fi is a work-and-lifestyle space to find, build, and collaborate with agent teams that grow with you.',
