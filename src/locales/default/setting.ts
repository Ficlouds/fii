...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'workspace.wizard.step2.billing.inviteAfterCreateHint':
    'You can invite teammates after this workspace is created.',
  ...
  'workspace.wizard.step2.chargeDisclosure':
    'Upon confirming purchase, your new workspace will be created on Pro and you will be charged ${{fee}}, plus any applicable taxes and fees, immediately and then every month, until you cancel. Seat fees and on-demand usage are settled at month-end; if your usage exceeds a billing threshold during a cycle, your payment method on file may be charged before the cycle ends.',
  ...
  'workspace.wizard.step2.hobbyAgreement':
    'By creating a Hobby workspace, no payment is due now. This plan has no monthly credit allowance; future top-ups or AutoTopUp usage are billed only after you confirm a purchase or enable AutoTopUp.',
  ...
  'workspace.wizard.step2.left.proTopUpHint':
    'Optional top-ups when the pool runs low — ${{price}} / M ({{percent}}% off the standard rate)',
