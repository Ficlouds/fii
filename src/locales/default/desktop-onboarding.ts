export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Fi. This helps us understand how Agents are used and make them better.',
  ...
  'screen5.actions.signInCloud': 'Sign in to Fi Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Fi Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Fi Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Fi server instance',
