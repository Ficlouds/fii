export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote Fi server to enable data synchronization',
  ...
  'sync.fiCloud.description': 'Officially provided cloud version',
  'sync.fiCloud.title': 'Fi Cloud',
