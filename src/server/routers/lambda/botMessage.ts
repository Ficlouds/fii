import type { MessagePlatformType } from '@ficlouds/builtin-tool-message';
import type { MessageRuntimeService } from '@ficlouds/builtin-tool-message/executionRuntime';
 ...
 * Fi account need their own session.
 */
