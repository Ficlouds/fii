...
<head>
  ...
  <title>Reset your Fi password</title>
</head>
<body style="margin:0;padding:0;background-color:#ffffff;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;color:#111111;">
  <div style="max-width:560px;margin:0 auto;padding:48px 24px;">
    ...
    <h1 style="font-size:20px;font-weight:600;color:#111111;margin:0 0 24px;line-height:1.3;">Password reset</h1>
    <p style="font-size:15px;color:#333333;margin:0 0 16px;line-height:1.6;">
      We received a request to reset the password for your Fi account.
    </p>
    <p style="font-size:15px;color:#333333;margin:0 0 32px;line-height:1.6;">
      <a href="${url}" style="color:#0066cc;text-decoration:none;font-weight:500;">Reset your password</a>
    </p>
