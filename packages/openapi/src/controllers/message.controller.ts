...
export class MessageController extends BaseController {
  ...
  async handleCountMessages(c: Context) {
    try {
      ...
      return this.success(c, result, 'Message count query successful');
    } catch (error) {
  ...
  async handleGetMessages(c: Context) {
    try {
      ...
      return this.success(c, result, 'Get message list successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
  ...
  async handleGetMessageById(c: Context) {
    try {
      ...
      return this.success(c, message, 'Get message details successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
  ...
  async handleDeleteBatchMessages(c: Context) {
    try {
      ...
      return this.success(c, result, 'Messages batch deleted successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
