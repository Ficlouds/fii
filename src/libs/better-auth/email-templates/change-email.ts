 ...
 * Sent when user requests to change their email address
 */
export const getChangeEmailVerificationTemplate = (params: {
  ...
  return {
    ...
    text: `Confirm your new email address\n\n${greeting}\n\nClick this link to confirm your new email address: ${url}\n\nThis link expires in ${expirationText}. If you did not request this change, your current email address will remain unchanged.\n\nFi`,
    html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
  ...
  <div style="max-width:580px;margin:0 auto;padding:48px 24px;">
    ...
    <div style="background:#ffffff;border-radius:16px;padding:48px 40px;border:1px solid rgba(0,0,0,0.06);">
      ...
      <p style="font-size:15px;color:#555555;margin:0 0 32px;line-height:1.6;">
        We received a request to update the email address on your Fi account. Click the button below to confirm this change. This link is valid for ${expirationText}.
      </p>
