...
export interface FiSkillProviderType {
  /**
...
/**
 * Predefined Fi Skill Provider list
 *
 * Note:
 ...
 */
export const LOBEHUB_SKILL_PROVIDERS: FiSkillProviderType[] = [
  {
    author: 'Fi',
    authorUrl: 'https://ficlouds.com',
    defaultVisible: true,
    description:
