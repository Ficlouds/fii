...
export class MessageTranslationController extends BaseController {
  ...
  async handleGetTranslateByMessage(c: Context) {
    try {
      ...
      return this.success(c, translate, 'Get translation information successfully');
    } catch (error) {
  ...
  async handleUpdateTranslateInfo(c: Context) {
    try {
      ...
      return this.success(c, result, 'Translation information updated successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
  ...
  async handleDeleteTranslate(c: Context) {
    try {
      ...
      return this.success(c, result, 'Translation information deleted successfully');
    } catch (error) {
      return this.handleError(c, error);
    }
  }
