...
describe('Generation Actions', () => {
  ...
  describe('delAndRegenerateMessage', () => {
    ...
    it('should delete message BEFORE regeneration to prevent message not found issue (delete message before regeneration to prevent stale message reappearing)', async () => {
