...
function rehypeFiAgents() {
  return (tree: any) => {
    visit(tree, (node, index, parent) => {
      // Handle <fiAgents .../> wrapped inside a <p> element
      ...
      // Handle bare <fiAgents .../> raw node (self-closing or opening tag)
