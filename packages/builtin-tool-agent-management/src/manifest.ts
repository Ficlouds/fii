...
export const AgentManagementManifest: BuiltinToolManifest = {
  api: [
    ...
    {
      description:
        "Install a plugin/tool for an agent. Use 'official' source for builtin tools, Klavis integrations, and FiSkill providers. Use 'market' source for MCP marketplace plugins.",
      ...
      parameters: {
        properties: {
          ...
          source: {
            description:
              "Plugin source: 'official' (builtin tools, Klavis, FiSkill) or 'market' (MCP marketplace)",
