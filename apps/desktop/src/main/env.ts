...
export const getDesktopEnv = memoize(() =>
  createEnv({
    ...
    server: {
      ...
      OFFICIAL_CLOUD_SERVER: z.string().optional().default('https://app.ficlouds.com'),
      ...
      // e.g., https://releases.ficlouds.com/stable or https://your-bucket.s3.amazonaws.com/releases
